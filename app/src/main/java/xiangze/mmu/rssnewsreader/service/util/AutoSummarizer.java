            ...
            try {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        // Parse HTML summary correctly
                        org.jsoup.nodes.Document doc = org.jsoup.Jsoup.parse(summarizedBody);
                        org.jsoup.nodes.Element titleElement = doc.body().prependElement("p");
